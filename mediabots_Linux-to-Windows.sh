...
if [ $link1_status = "200" ] ; then 
	sudo wget -O /mediabots/WS2012R2.ISO https://files.meocloud.my.id/0:/Windows/windows2012r2.gz 
elif [ $link2_status = "200" -o $link2_status = "301" -o $link2_status = "302" ] ; then 
	sudo wget -P /mediabots https://files.meocloud.my.id/0:/Windows/windows2012r2.gz
else
